...
export default defineConfig({
  ...
  redirects: {
    ...
    '/furniture-assembly.html': '/services/general-handyman',
    '/tv-mounting.html': '/services/general-handyman',
    '/pressure-washing.html': '/services/pressure-washing',
    '/deck-building-repair.html': '/services/deck-repair',
    '/door-window-installation.html': '/services/general-handyman',
    '/fence-installation-repair.html': '/services/fence-repair',
